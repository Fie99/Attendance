    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isConnectedtoInternet(AttendanceScreen.this)) {
                    ...
                    documentReference.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(AttendanceScreen.this, "Error: " + Objects.requireNonNull(task.getException()).getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
                else {
                    Toast.makeText(AttendanceScreen.this, "Please connect to internet to see module attendance", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        documentReference.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    if (userType != null) {
                        // Your existing code for the case when userType is not null
                     ...
                     */
                        ...
                        // Handle the case when userType is null, possibly show an error message or take appropriate action
                        Log.e("userType", "userType is null");
                    }
                    ...
                    if (userType != null && userType.equals("Admin")) {
                        // Your existing code for the case when userType is not null and equals "Admin"
                        submitBtn.setVisibility(View.GONE);
                        spinner.setVisibility(View.GONE);
                    } else {
                        // Handle the case when userType is null or not equal to "Admin"
                        // This is optional based on your app's logic
                       // Log.e("YourTag", "userType is null or not equal to Admin");
                        ...
                        final ArrayAdapter<String> adapter = new ArrayAdapter<>(getApplicationContext(), android.R.layout.simple_spinner_item, unitsList);
                    ...
                    Toast.makeText(AttendanceScreen.this, "Error: " + task.getException(), Toast.LENGTH_LONG).show();
                }
            }
        });
    }
